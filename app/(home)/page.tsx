...
const Page = async (props: Props) => {
	const databases: DatabaseSchema[] = (await getDatabaseList()) as DatabaseSchema[];
	return (
		<div>
			<div className='grid gap-3 md:grid-cols-2 lg:grid-cols-3'>
				...
				<Link href='/database'>
					<Card className='cursor-pointer transition-colors duration-200 hover:border-primary border border-opacity-10'>
						...
						<CardContent>
							<div className='text-xl font-bold'>{databases.length} Active Databases</div>
							<p className='text-xs text-muted-foreground'>3 MongoDB + 2 MySQL Databases</p>
						</CardContent>
					</Card>
				</Link>
				<Link href='/endpoints'>
